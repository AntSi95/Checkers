namespace Checkers.Engine.Models
{
    ...
    // TODO: Попробвать перевести логику с int на более дешёвый тип.
    /// <summary>
    ...
    // TODO [Optimization]: Пропробовать перевести рекорд-класс Move в readonly record struct.
    // Это исключит аллокации памяти в куче при генерации сотен тысяч вариантов ходов.
    // Опасность - рекорд сейчас весит больше чем стоит для простой strurt record, возможно необходим модификатор in.
    /// <summary>
